...
CREATE TABLE `ums_admin_login_log` (
  ...
  CONSTRAINT `ums_admin_login_log_ibfk_1` FOREIGN KEY (`admin_id`) REFERENCES `ums_admin` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=287 DEFAULT CHARSET=utf8mb3 COMMENT='后台用户登录日志表';
...
CREATE TABLE `ums_resource` (
  ...
  CONSTRAINT `fk_resource_category` FOREIGN KEY (`category_id`) REFERENCES `ums_resource_category` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=32 DEFAULT CHARSET=utf8mb3 COMMENT='后台资源表';
...
CREATE TABLE `ums_role_menu_relation` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_role_menu_relation_menu` (`menu_id`),
  KEY `fk_role_menu_relation_role` (`role_id`),
  CONSTRAINT `fk_role_menu_relation_menu` FOREIGN KEY (`menu_id`) REFERENCES `ums_menu` (`id`),
  CONSTRAINT `fk_role_menu_relation_role` FOREIGN KEY (`role_id`) REFERENCES `ums_role` (`id`)
...
CREATE TABLE `ums_role_resource_relation` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_role_resource_relation_role` (`role_id`),
  KEY `fk_role_resource_relation_resource` (`resource_id`),
  CONSTRAINT `fk_role_resource_relation_resource` FOREIGN KEY (`resource_id`) REFERENCES `ums_resource` (`id`),
  CONSTRAINT `fk_role_resource_relation_role` FOREIGN KEY (`role_id`) REFERENCES `ums_role` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=216 DEFAULT CHARSET=utf8mb3 COMMENT='后台角色资源关系表';
